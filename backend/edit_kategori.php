...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  header("Location: ../admin/kategori.php?status=updated");
  exit;
}
?>
...
<div class="content-wrapper">
  <section class="content-header">
    <h1 class="mb-3">
      <i class="fas fa-edit text-warning mr-2"></i> Edit Kategori Faskes
    </h1>
  </section>
    ...
    <div class="card shadow">
      <div class="card-header bg-warning text-white">
        <h3 class="card-title mb-0">
          <i class="fas fa-pen-square"></i> Edit Kategori
        </h3>
      </div>
      <div class="card-body">
        <form method="POST">
